...
export declare class ArrayNode extends Node {
    ...
    dumpRecursively(refsBuilder: IRefsBuilder): (import("cc").__private._cocos_core_data_deserialize__AnyData | Node)[];
}
...
export declare class ClassNode extends Node {
    ...
    advanceds: (string | number | boolean | object | number[] | import("cc").__private._cocos_core_data_deserialize__IClassObjectData | import("cc").__private._cocos_core_data_deserialize__IClassObjectData[] | import("cc").__private._cocos_core_data_deserialize__IDictData | import("cc").__private._cocos_core_data_deserialize__IArrayData | import("cc").__private._cocos_core_data_deserialize__IValueTypeData | import("cc").__private._cocos_core_data_deserialize__ITRSData | import("cc").__private._cocos_core_data_deserialize__ICustomObjectData | Node | null | undefined)[];
